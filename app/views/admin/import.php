...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Import Data Peserta</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/admin">Home</a></li>
                    <li class="breadcrumb-item"><a href="/admin/data">Data Management</a></li>
                    <li class="breadcrumb-item active">Import Data Peserta</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-6">
                <div class="card card-outline card-success">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Cookie Status -->
                        <div
                            class="alert alert-<?php echo $cookieStatus === 'configured' ? 'success' : 'warning'; ?> mb-3">
                        ...
                        <small class="text-muted">
                            <i class="fas fa-info-circle mr-1"></i> Auto-import akan download Excel dari server utama
                            dan
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-radio mb-2">
                                    <input class="custom-control-input" type="radio" id="typeFormulir"
                                        name="import_type" value="formulir_masuk" checked>
                                    <label for="typeFormulir" class="custom-control-label">
                                        <strong>1. Formulir Masuk</strong><br>
                                        <span class="text-muted text-sm font-weight-normal">Import biodata baru. Status
                                            Berkas
                                ...
                                <div class="custom-control custom-radio mb-2">
                                    ...
                                    <label for="typeLulus" class="custom-control-label">
                                        ...
                                        <span class="text-muted text-sm font-weight-normal">Update status menjadi
                                            <strong>Lulus Verifikasi</strong>. Mengambil data pembayaran (Bank/Kanal)
                                            dari file
                                            ini.</span>
                                    </label>
                                </div>
                                ...
                                <!-- 4. Nomor Peserta -->
                                <div class="custom-control custom-radio mb-2">
                                    <input class="custom-control-input" type="radio" id="typeNoPeserta"
                                        name="import_type" value="nomor_peserta">
                                    <label for="typeNoPeserta" class="custom-control-label">
                                        ...
                                        <span class="text-muted text-sm font-weight-normal">Hanya update <strong>Nomor
                                                Peserta</strong>. Mengabaikan kolom pembayaran (karena sering tidak
                                            lengkap di
                                            file ini).</span>
                                    </label>
                                </div>
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <small class="form-text text-muted">
                                        <strong>Insert New Only (Recommended):</strong> Data yang sudah ada di database
                                        akan
                                        dilewati, hanya data baru yang di-import.<br>
                                        <strong>Update Existing:</strong> Hanya update data yang sudah ada, skip data
                                        baru.<br>
                                        <strong>Insert and Update:</strong> Import data baru DAN update data yang sudah
                                        ada
                                        (behavior lama).
                                    </small>
                                </div>
                                ...
                                <div class="custom-control custom-checkbox mt-3">
                                    ...
                                    <br>
                                    <small class="text-muted">Centang jika file menggunakan format lama (Kolom
                                        <strong>"Tempat,
                                            Tanggal Lahir"</strong> digabung contoh: "Banjarmasin, 10 Maret
                                        1991").</small>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" name="file" class="custom-file-input" id="customFile"
                                        accept=".xls,.xlsx" required onchange="updateFileName(this)">
                                    <label class="custom-file-label" for="customFile">Pilih file...</label>
                                </div>
                                <small class="text-muted">Mendukung format dari bank BNI (HTML/XLS) dan standar
                                    Excel.</small>
                            </div>
                        </div>
