                    ...
                    <form method="GET" action="/admin/attendance-print" target="_blank">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="perPage" id="perPageInput" class="form-control mt-2" 
                                       min="5" max="50" value="18" style="display: none;" 
                                       placeholder="Masukkan jumlah (5-50)">
                                <small class="form-text text-muted">Tentukan berapa banyak peserta per halaman cetak (5-50)</small>
                            </div>
