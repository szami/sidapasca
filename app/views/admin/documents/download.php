...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Download Berkas</h1>
            </div>
            <div class="col-sm-6">
                            ...
                            <div class="col-md-4">
                                ...
                                <?php if ($isAdminProdi): ?>
                                    <select id="statusFilter" class="form-control" disabled>
                                        <option value="peserta_ujian" selected>🎓 Peserta Ujian (Punya Nomor Peserta)
                                        </option>
                                    </select>
                        ...
                        <div id="previewSection" style="display: none;">
                            <div class="alert alert-info">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <strong>Status:</strong> <span id="previewStatus"
                            ...
                            <div class="card border-warning">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted mt-3 mb-0">
                                        ...
                                        <small>Mohon tunggu, proses ini mungkin memakan waktu beberapa menit untuk data
                                            besar.
